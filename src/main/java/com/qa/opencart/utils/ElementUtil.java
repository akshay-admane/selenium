...
public class ElementUtil {
	...
	public void printViolet(String text) {
	    final String ANSI_VIOLET = "\u001B[35m";
	    final String ANSI_RESET = "\u001B[0m";
	    System.out.println(ANSI_VIOLET + text + ANSI_RESET);
	}
	...
	public void printOrange(String text) {
	    ...
	    final String ANSI_RESET = "\u001B[0m";
	    System.out.println(ANSI_ORANGE + text + ANSI_RESET);
	}

	public void printHyperlink(String text) {
	    final String ANSI_BLUE_UNDERLINE = "\u001B[34;4m"; // Blue color with underline
	    final String ANSI_RESET = "\u001B[0m";
	    System.out.println(ANSI_BLUE_UNDERLINE + text + ANSI_RESET);
	}
}
